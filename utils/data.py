...
def build_transform_coda_prompt1(is_train, args):
    if is_train:
        transform = [
            transforms.RandomResizedCrop(224),
            transforms.ToTensor(),
...
class iBloodMNIST_224(iData):
    ...
    def download_data(self):
        ...
        test_dir = "./data/bloodmnist_224/test/"
...
class iPathMNIST_224(iData):
    ...
    def download_data(self):
        # assert 0, "You should specify the folder of your dataset"
        train_dir = "./data/pathmnist_224/train/"
        test_dir = "./data/pathmnist_224/test/"
...
class iOrganaMNIST_224(iData):
    def __init__(self, args):
        ...
        self.class_order = np.arange(11).tolist()

    def download_data(self):
        # assert 0, "You should specify the folder of your dataset"
        train_dir = "./data/organamnist_224/train/"
        test_dir = "./data/organamnist_224/test/"
...
class iRetinalOCT(iData):
    ...
    def download_data(self):
        # assert 0, "You should specify the folder of your dataset"
        train_dir = "./data/RetinalOCT/train/"
        test_dir = "./data/RetinalOCT/test/"
...
class iJSIEC(iData):
    def __init__(self, args):
        ...
        if args["model_name"] == "coda_prompt":
            self.train_trsf = build_transform_coda_prompt(True, args)
            self.test_trsf = build_transform_coda_prompt1(True, args)
        else:
            self.train_trsf = build_transform(True, args)
            self.test_trsf = build_transform(False, args)
        self.common_trsf = [
        ...
        self.class_order = np.arange(39).tolist()

    def download_data(self):
        # assert 0, "You should specify the folder of your dataset"
        train_dir = "./data/JSIEC/train/"
        test_dir = "./data/JSIEC/test/"
